...
class _ExerciciosSelecaoState extends State<ExerciciosSelecao> {
  ...
  void _filtrarExercicios() {
    setState(() {
      exerciciosFiltrados = exercicios.where((exercicio) {
        ...
        bool matchesTipo = tipoSelecionado == null || 
                    ...
                    onPressed: () async {
                      ...
                      if (series > 0 && repeticoes > 0) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Séries e repetições devem ser maiores que 0'),
                          ),
                        );
                      }
                    },
  ...
  Future<void> _adicionarExercicioAoTreino(
    ...
    try {
      ...
      if (responseExerSelec.statusCode == 200 || responseExerSelec.statusCode == 201) {
        ...
        if (responseTreinosLink.statusCode == 200 || responseTreinosLink.statusCode == 201) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
          ...
          // Atualiza a tela anterior e volta
